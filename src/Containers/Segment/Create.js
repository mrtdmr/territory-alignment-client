...
const Create = props => {
  ...
  return <Segment clearing><Form>
    <Form.Field>
      <label>Oran</label>
      <Input placeholder='Oran'
        name='rate'
        value={segment.rate}
    ...
    <Button floated='right' positive content='Ekle' onClick={(e) => props.add(e, { rate: segment.rate, targetFrequency: segment.targetFrequency, deductionDetailId: props.deductionDetailId })} />
